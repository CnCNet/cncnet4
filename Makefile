...
cncnet.exe: cncnet.dll.xz res/cncnet.rc.in src/client.c src/wait.c src/update.c src/download.c src/connect.c src/settings.c src/test.c src/http.c src/config.c src/net.c
	...
	i586-mingw32msvc-gcc $(CLIENT_CFLAGS) -mwindows -o cncnet.exe src/client.c src/wait.c src/update.c src/download.c src/connect.c src/settings.c src/test.c src/http.c src/config.c src/net.c xz/xz_crc32.c xz/xz_dec_lzma2.c xz/xz_dec_stream.c res/cncnet.rc.o -Wl,--file-alignment,512 -Wl,--gc-sections -lws2_32 -lwininet -lcomctl32
