...
dll: src/cncnet.c src/net.c
	...
	$(CC) $(CFLAGS) -DBUILD_DLL -DINTERNET -Wl,--enable-stdcall-fixup -shared -s -o cncnet.dll src/cncnet.c src/net.c src/base32.c src/uri.c src/cncnet.def res/dll.o $(LIBS)
