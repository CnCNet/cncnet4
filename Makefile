...
lan: src/wsock32.c src/wsock32_lan.c src/sockets.c src/loader.c
	...
	$(CC) $(CFLAGS) -DBUILD_DLL -Wl,--enable-stdcall-fixup -shared -s -o wsock32-lan.dll src/wsock32.c src/wsock32_lan.c src/sockets.c src/wsock32.def src/loader.c src/dll.o $(LIBS)

internet: src/wsock32.c src/wsock32_internet.c src/sockets.c src/loader.c
